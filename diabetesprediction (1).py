...
diabetes_dataset = pd.read_csv("~/Desktop/diabetes/diabetes.csv")
...
subset_diabetes_dataset = diabetes_dataset[
...
plt.figure(figsize=(10, 6))
sns.histplot(
    data=subset_diabetes_dataset, x="BMI", hue="Outcome", kde=True, palette="husl"
)
...
plt.figure(figsize=(10, 6))
sns.scatterplot(
    data=subset_diabetes_dataset, x="Glucose", y="BMI", hue="Outcome", palette="husl"
)
